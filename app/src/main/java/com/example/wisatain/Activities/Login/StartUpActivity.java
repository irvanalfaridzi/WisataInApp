        ...
        if (getUID == null) {
            mUsers.child(getUID).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    mAuth.signInWithEmailAndPassword(dataSnapshot.child("Email").getValue(String.class), dataSnapshot.child("Password").getValue(String.class)).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        @Override
